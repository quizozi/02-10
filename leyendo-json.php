...
<h5>Algunos de ellos están instalados en Nueva Zelanda</h5>

<?php $year=0;?>
<ol>
<?php for($n = 0; $n < $todos; $n++){?>
  <?php if(($datos[$n]['country_code']) == 'NZ'){?>
...
<h5><?php echo $year;?> de los instalados en Nueva Zelanda han generado indicadores durante este año</h5>
